"""
v4: Validation of the `links` field.

In this example, we can see how a validation that textually describes the
error can be sufficient for the LLM to correct it in a later phase.
"""
